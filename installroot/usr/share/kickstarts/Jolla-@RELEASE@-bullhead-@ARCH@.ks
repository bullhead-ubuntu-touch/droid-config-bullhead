# DisplayName: Jolla bullhead/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: bullhead
# DeviceVariant: bullhead
# Brand: Jolla
...
repo --name=adaptation-common-bullhead-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-bullhead-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-bullhead
%end
